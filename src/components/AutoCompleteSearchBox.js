...
const AutoCompleteSearchBox = ({ movieTitleResults, selectedOption, setSelectedOption, onGuessSubmit }) => {
    ...
    <h2>This is the AutoCompleteSearchBox component</h2>
        ...
        <Stack sx={{ width: 500 }}>
            <Autocomplete
                ...
                noOptionsText='sorry pal, nothing matches what you have typed in'
